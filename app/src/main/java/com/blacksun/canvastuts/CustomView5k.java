...
public class CustomView5k extends View {
    private int mWidth;
    private int mHeight;
    ...
    private final int LIMIT = 150000;

    public CustomView5k(Context context) {
        super(context);
        init(context, null);
    }

    public CustomView5k(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomView5k(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
